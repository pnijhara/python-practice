...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 17:38:16 2018
...
print('New hand : cccllaapppttrr')
myHand = Hand(14)
myHand.setDummyHand('cccllaapppttrr')
#print(myHand.calculateLen())
#print(myHand.getFrequencyDict('claptrap'))
print(myHand.update('claptrap'))
print(myHand)
print('Correct output: cclprt')